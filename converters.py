...
class StashToNfoConverter:
    ...
    def convert(self, stash_data: Dict[str, Any], data_type: str) -> Dict[str, Any]:
        """
    ...
    def _convert_performers_to_actors(self, performers: List[Union[str, Dict[str, Any]]]) -> List[Dict[str, Any]]:
